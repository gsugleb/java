import by.gsu.pmslab.AccountType;
import by.gsu.pmslab.BuisnessTrip;
                    ...
                    if (Integer.parseInt(item.trim()) == currIndex) {
                        ...
                        switch (field) {
                            case ACCOUNT_FIELD: {
                                ...
                                currentTrip.setAccount(AccountType.valueOf(value.toUpperCase()));
                                break;
                            }
                            case TRANSPORT_FIELD:
                                currentTrip.setTransportExpences(Integer.parseInt(value));
                                break;
                            case DAYS_FIELD:
                                currentTrip.setDays(Integer.parseInt(value));
                                break;
                        }
                    }
                }
